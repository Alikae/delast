...
/*
		...
		try {
			...
			$req = $bdd->prepare("INSERT INTO realisations (nom, description, photo) VALUES (?, ?, ?)");
			$req->execute(array($_POST['nom'], $_POST['description'], $photourl));
		} catch(Exception $e) {
